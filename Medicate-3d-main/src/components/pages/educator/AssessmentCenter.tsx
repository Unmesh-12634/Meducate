...
import { Plus, Download, Eye, Edit, CheckCircle, Clock, Search } from 'lucide-react';
          ...
          <div className="flex gap-3">
            {['all', 'active', 'closed'].map((status) => (
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className={`px-6 py-3 rounded-xl border-2 transition-all capitalize ${filterStatus === status
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-center">
                        <motion.span
                          ...
                          className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs ${assignment.pending > 0
                      ...
                      <td className="py-4 px-6 text-center">
                        <motion.span
                          whileHover={{ scale: 1.1 }}
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs ${assignment.status === 'active'
                            ? 'bg-green-500/10 text-green-500'
