...
import { Search, Send, Paperclip, Clock, CheckCheck } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto">
              {filteredChats.map((chat, index) => (
                <motion.div
                  ...
                  className={`p-4 border-b border-border cursor-pointer transition-all ${selectedChat === chat.id ? 'bg-[#FFD166]/10 border-l-4 border-l-[#FFD166]' : ''
                    }`}
                >
                  ...
                  >
                    <div className={`max-w-[70%] ${message.sender === 'educator' ? 'order-2' : 'order-1'}`}>
                      <motion.div
                        ...
                        className={`p-4 rounded-2xl ${message.sender === 'educator'
                      ...
                      <div className={`flex items-center gap-2 mt-1 text-xs text-muted-foreground ${message.sender === 'educator' ? 'justify-end' : 'justify-start'
                        }`}>
                        <Clock size={12} />
