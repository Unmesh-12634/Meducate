...
import { Plus, Eye, Edit, Send, Search, FileText } from 'lucide-react';
import { ImageWithFallback } from '../../figma/ImageWithFallback';

export function SimulationManager() {
  const [searchTerm, setSearchTerm] = useState('');
  const [filterStatus, setFilterStatus] = useState('all');
  // const [selectedSimulation, setSelectedSimulation] = useState<number | null>(null); // unused
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4 flex gap-2">
                    <motion.span
                      ...
                      className={`px-3 py-1 rounded-full text-xs ${sim.status === 'active'
