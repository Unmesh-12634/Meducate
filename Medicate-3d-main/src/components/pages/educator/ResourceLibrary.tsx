...
import { Upload, Download, Share2, Eye, Trash2, FileText, Video, File, Search } from 'lucide-react';
              ...
              <div className="flex gap-2">
                {types.map((type) => (
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`px-4 py-2 rounded-xl border-2 transition-all capitalize text-sm ${filterType === type
