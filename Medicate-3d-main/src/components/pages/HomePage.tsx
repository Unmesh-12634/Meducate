  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              <span className="text-[#00A896] text-sm">{t('home.badge')}</span>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>10,000+ {t('home.stat_students')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Zap size={16} className="text-[#FFD166]" />
                <span>500+ {t('home.stat_scenarios')}</span>
              </div>
              <div className="flex items-center gap-2">
                <Zap size={16} className="text-[#FFD166]" />
                <span>95% {t('home.stat_pass')}</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl mb-4">{t('home.cta_title')}</h2>
