...
export function LandingPage({ onLogin, onSignup }: LandingPageProps) {
  ...
  const features = [
    {
      icon: Stethoscope,
      title: t('landing.grid_feat1_title'),
      description: t('landing.grid_feat1_desc'),
    },
    {
      icon: Users,
      title: t('landing.grid_feat2_title'),
      description: t('landing.grid_feat2_desc'),
    },
    {
      icon: Brain,
      title: t('landing.grid_feat3_title'),
      description: t('landing.grid_feat3_desc'),
    },
    {
      icon: GraduationCap,
      title: t('landing.grid_feat4_title'),
      description: t('landing.grid_feat4_desc'),
    },
  ];

  const stats = [
    { value: '10,000+', label: t('landing.stat_students'), icon: Users },
    { value: '500+', label: t('landing.stat_scenarios'), icon: Stethoscope },
    { value: '95%', label: t('landing.stat_pass'), icon: TrendingUp },
    { value: '24/7', label: t('landing.stat_support'), icon: Brain },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-[#00A896] text-sm">{t('landing.badge')}</span>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            >
              ...
              <h3 className="text-2xl mb-3">{t('landing.feat1_title')}</h3>
              <p className="text-muted-foreground mb-4">
                {t('landing.feat1_desc')}
              </p>
              <ul className="space-y-2">
                {[t('landing.feat1_li1'), t('landing.feat1_li2'), t('landing.feat1_li3')].map((item) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            ...
            >
              ...
              <h3 className="text-2xl mb-3">{t('landing.feat2_title')}</h3>
              <p className="text-muted-foreground mb-4">
                {t('landing.feat2_desc')}
              </p>
              <ul className="space-y-2">
                {[t('landing.feat2_li1'), t('landing.feat2_li2'), t('landing.feat2_li3')].map((item) => (
                  <li key={item} className="flex items-center gap-2 text-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <h3 className="text-2xl mb-3">{t('landing.feat3_title')}</h3>
              <p className="text-muted-foreground mb-4">
                {t('landing.feat3_desc')}
              </p>
              <ul className="space-y-2">
                {[t('landing.feat3_li1'), t('landing.feat3_li2'), t('landing.feat3_li3')].map((item) => (
                  <li key={item} className="flex items-center gap-2 text-sm">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative p-12 text-center text-white">
            ...
            >
              <Award size={16} />
              <span className="text-sm">{t('landing.cta_badge')}</span>
            </motion.div>
            <h2 className="text-4xl mb-4">{t('landing.cta_title')}</h2>
