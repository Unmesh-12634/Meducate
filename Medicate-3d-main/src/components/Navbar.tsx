import { Moon, Sun, Menu, X, LogOut, User, Globe } from 'lucide-react';
...
export function Navbar({ currentPage, onNavigate, onLogout, userRole = 'student', language = 'en', setLanguage }: NavbarProps) {
  ...
  const studentNavItems = [
    ...
    { id: 'simulator', label: t('nav.lab') },
    { id: 'learn', label: t('nav.learn') },
    { id: 'play', label: t('nav.simulator') },
  ...
  const educatorNavItems = [
    { id: 'educator-dashboard', label: t('nav.edu_dashboard') },
    { id: 'educator-courses', label: t('nav.edu_courses') },
    { id: 'educator-simulations', label: t('nav.edu_simulations') },
    { id: 'educator-analytics', label: t('nav.edu_analytics') },
    { id: 'educator-communication', label: t('nav.edu_messages') },
    { id: 'educator-assessments', label: t('nav.edu_assessments') },
    { id: 'educator-resources', label: t('nav.edu_resources') },
  ];
          ...
          <div className="hidden md:flex items-center gap-2">
            {navItems.map((item, index) => (
              <motion.button
                ...
                className={`px-4 py-2 rounded-xl transition-all relative overflow-hidden group ${currentPage === item.id
                  ? userRole === 'educator'
              ...
              <div className="hidden md:flex items-center gap-1 bg-muted rounded-xl p-1">
                ...
                {LANG_OPTIONS.map((opt) => (
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${language === opt.code
            ...
            <div className="px-4 py-4 space-y-2">
              {navItems.map((item, index) => (
                <motion.button
                  ...
                  className={`w-full text-left px-4 py-3 rounded-xl transition-all ${currentPage === item.id
                    ? userRole === 'educator'
